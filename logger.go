...
var logfile *LogFile
var (
	//Debug отправка debug сообщения
	Debug *log.Logger
	//Trace отправка trace сообщения
	Trace *log.Logger
	//Info отправка info сообщения
	Info *log.Logger
	//Warning отправка warning сообщения
	Warning *log.Logger
	//Error  отправка error сообщения
	Error *log.Logger
)
